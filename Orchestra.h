...
class Orchestra{
    ...
    int num_musicians;   // store the curent number of musicians
    int max_musicians;   // store the the maximum of number of musician
    Musician *musicians; // array of musicians
